...
namespace CamplyMarket.Persistence.Migrations
{
    ...
    [Migration("20231208110224_Mig_7")]
    partial class Mig_7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CamplyMarket.Domain.Entities.Identity.AppRole", b =>
                {
            ...
            modelBuilder.Entity("CamplyMarket.Domain.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CamplyMarket.Domain.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CamplyMarket.Domain.Entities.Identity.AppUser", null)
                        .WithMany()
